...
//+kubebuilder:printcolumn:name="SubPath",type="string",JSONPath=`.spec.gitRepository.subPath`
//+kubebuilder:printcolumn:name="Age",type="date",JSONPath=".metadata.creationTimestamp",description=""
//+kubebuilder:printcolumn:name="Revision",type="string",JSONPath=".status.artifact.revision",description=""
